# this is a complicated array- not only is it multidimensional, but it's also irregular. And the 2nd dimension uses a different structure (values as opposed to key value pairs)
aListOfAttributeValues = {
							"Personal Background"         : "I was born in the mountains of North Carolina in a small town called \"Linville Falls\". I have spent most of my years here in NC but also lived for a few  years in Palmetto, Florida.",
...
print('ITEMS:\n')
print(aListOfAttributeValues.items())

print('VALUES:\n')
print(aListOfAttributeValues.values())

print('KEYS:\n')
print(aListOfAttributeValues.keys())

for i in aListOfAttributeValues: 
	print()
